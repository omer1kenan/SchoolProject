...
namespace SchoolProject.Service.Implementaions
{
    public class StudentService : IStudentService
    {
        ...
        {
            var studentResult = _sudentRepository.GetTableNoTracking().Where(x => x.Name.Equals(student.Name)).FirstOrDefault();
            if (studentResult != null) return "Exist";
            await _sudentRepository.AddAsync(student); return "Success";
        }
    }
}
